...
const ProductsManagement = () => {
  ...
  const getAvailabilityStatus = (product) => {
    if (!product.isRentable) return 'Disabled';
    if (product.availableStock > 0) return 'Available';
    return 'Out of Stock';
  };
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center mb-8">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            Manage your rental product catalog, pricing, and availability.
          </p>
        </div>
      ...
      {/* Search Input Bar (Admin Products Only) */}
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">
                    {products.filter(p => getAvailabilityStatus(p) === 'Out of Stock').length}
                  </dd>
                </dl>
              </div>
            </div>
                ...
                return (
                  <tr key={product.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900 font-medium">{product.category || 'Uncategorized'}</div>
                      {product.brand && (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold ${getStatusBadgeColor(status)}`}>
                        {status}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      <div>{product.availableStock} / {product.stock} units</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex justify-end space-x-2">
                        <Link 
                          to={`/admin/products/edit/${product.id}`}
                          className="text-blue-600 hover:text-blue-900 bg-blue-50 hover:bg-blue-100 px-3 py-1.5 rounded-md text-xs font-bold transition-colors"
                        >
                          Edit
                        </Link>
                        <button 
                          onClick={() => handleDeleteProduct(product)}
                          className="text-red-600 hover:text-red-900 bg-red-50 hover:bg-red-100 px-3 py-1.5 rounded-md text-xs font-bold transition-colors"
                        >
                          Delete
                        </button>
                      </div>
