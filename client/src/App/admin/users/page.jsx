      ...
      <div className="sm:flex sm:items-center mb-6">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700 font-medium">
            Manage user accounts, change privileges, and revoke permissions.
          </p>
        </div>
      </div>
        ...
        <nav className="flex space-x-8">
          {[
            ...
            return (
              ...
              >
                {tab.label} <span className="ml-1 text-xs px-2 py-0.5 bg-gray-100 text-gray-600 rounded-full">{count}</span>
              </button>
            );
          })}
        </nav>
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden border border-gray-200">
        ...
        {getFilteredUsers().length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">No users match the selected role filter.</p>
          </div>
        )}
      </div>
